...
class RobotCamera():
    def __init__(self):
        ...
        # Imprimir el directorio de trabajo actual y la ruta del modelo
        rospy.loginfo(f"Script directory: {script_dir}")
        rospy.loginfo(f"Model path: {model_path}")
        
        # Cargar el modelo YOLOv8
        self.model = YOLO(model_path)  # Reemplaza "yolov8n.pt" con el modelo que desees usar
    ...
    def camera_cb(self, msg):
        ...
        image_path = os.path.join(script_dir, f"detected_{timestamp}.jpg")
