            ...
            if found_color1 or found_color2:
                ...
                if radius <= 140:
                    ...
                    if not self.obstacle_detected:
                        ...
                        self.speed.angular.z = -error_x / 180
                    else:
                        self.speed.linear.x = 0.0
                        if self.obstacle_side == "left":
                            self.speed.angular.z = -0.5  # Gira a la derecha para evitar el obstáculo
                        else:
                            self.speed.angular.z = 0.5  # Gira a la izquierda para evitar el obstáculo
